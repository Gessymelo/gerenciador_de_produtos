      ...
      <h2 style={{position:'relative'}}>
          ...
          {tooltipAberto && (
            <div className="tooltip">
              { id ? 'Nesta tela, você pode editar as informações de um fornecedor existente.' : 'Nesta tela,você pode adicionar um novo fornecedor no sistema.'}
            </div>
          )}
      </h2>

      <form className="forncedor-form">
        <div className='form-group'>
            <label htmlFor='nome'>Nome do fornecedor:</label>
            <input type='text' className='form-control' 
            id='nome' name="nome" value={fornecedor.nome} 
        ...
        <div className='form-group'>
          ...
          <InputMask mask="99.999.999/9999-99" className="form-control"
           id="cnpj" name="cnpj" value={fornecedor.cnpj} 
        ...
        <div className='form-group'>
          ...
          <input type="email" className="form-control"
            ...
            title="Digite um email válido" value={fornecedor.email}
